...
export class MessageFactory {
     ...
     public static buildHandshakePacket(infoHash, peerId) {
     ...
     public static parseHandshake(payload) {
     ...
     public static getInterestedMsg() {
        const msg = Buffer.alloc(5);
        msg.writeUInt32BE(1, 0); //len
     ...
     public static getNotInterestedMsg() {
        const msg = Buffer.alloc(5);
        msg.writeUInt32BE(1, 0); //len
     ...
     public static getHaveMsg(pieceIndex) {
     ...
     public static getBitFieldMsg(payload) {
     ...
     public static getRequestMsg(payload) {
     ...
     public static sendPiece(payload) {
     ...
     public static getCancelMsg(payload) {
        const msg = Buffer.alloc(17);
